      ...
      <div className="max-w-6xl mx-auto px-4 space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">{user.phone}</h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800">₹{transactions.reduce((sum, txn) => sum + txn.amount, 0)}</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800">₹{Math.floor(transactions.reduce((sum, txn) => sum + txn.amount, 0) * 0.05)}</h3>
